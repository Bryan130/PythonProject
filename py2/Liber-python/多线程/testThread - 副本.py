...
def updateDeviceStatus(access_Token, did, dpid, dpvalue):
...
def thread_main():
    ...
    if ready[0]:
        ...
        print "data",data
        rdata =data
        devcmd= hex_data(0,"string","111")
        print "devcmd",devcmd
        # devcmd= hex_data(dpindex,dptype,dpvalue)
        # print "devcmd: ", devcmd
        if (data == devcmd):
            print "assert equal."
        else:
...
if __name__ == '__main__':
    ...
    # dpid = "stringrw"
    # did = "kykbFpFgbmrV"
    # res = updateDeviceStatus(access_Token, did, dpid, dpvalue)
    res = updateDeviceStatus(access_Token, "kykbFpFgbmrV", "stringrw", "111")
    print "res",res
    time.sleep(2)
    print rdata
